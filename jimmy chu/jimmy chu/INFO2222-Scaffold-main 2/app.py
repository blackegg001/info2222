...
def repository():
    ...
    if form.validate_on_submit():
        ...
        print(user_inputs)
        return render_template('repository.jinja', username = username, user_text=user_text, form=form, user_inputs=user_inputs[username])
    return render_template('repository.jinja', username = username, form=form, user_inputs = [])
